...
public class PartTwo {
    ...
    public static void main(String[] args) {
        ...
        for ( int k = 0; k < 3; k++ ) {
            ...
            ArrayList<Double> pgList = g.calculatePageRank(g.getEdgeList(), 0, 0.85, 1000);
            if ( pgList != null ) {
        ...
        System.out.println("\nAverage time of 100 pages: " + avgTime1 / 3 + " milli seconds.");
        ...
        System.out.println("\nAverage time of 500 pages: " + avgTime1 / 3 + " milli seconds.");
        ...
        System.out.println("\nAverage time of 1000 pages: " + avgTime1 / 3 + " milli seconds.");
        ...
        System.out.println("\nAverage time of 2000 pages: " + avgTime1 / 3 + " milli seconds.");
        ...
        System.out.println("\nAverage time of 5000 pages: " + avgTime1 / 3 + " milli seconds.");
        ...
        System.out.println("\nAverage time of 10000 pages: " + avgTime1 / 3 + " milli seconds.");
    }
}